function C4_glm_2ndLevel_FlexFact(src_dir, SJin, outputfolder, dir_1st, con_images, runs)
...
%             f             = spm_select('List', temp_dir, 's5wres_accuracy_minus_chance.nii');
        ...
        matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(sj).conds = [1:10]'; %% AAACHTUNG

function C3_glm_2ndLevel(src_dir, SJin, outputfolder, dir_1st, cnames)
...
%             f             = spm_select('List', temp_dir, filt);
    ...
    for c = 1:numCons
        ...
        matlabbatch{3}.spm.stats.con.consess{c}.tcon.name    = connames{c};       
        matlabbatch{3}.spm.stats.con.consess{c}.tcon.weights = convecs{c};         
